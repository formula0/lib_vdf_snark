...
use ark_sponge::{poseidon::PoseidonParameters, CryptographicSponge, FieldBasedCryptographicSponge};
//use bellman_bignat::util::test_helpers::Bls12;

const TEST_INPUTS: [&str; 2] = [
...
#[test]
fn test_dusk_poseidon() {
    use dusk_poseidon::sponge;
    use dusk_bls12_381::BlsScalar;
    use dusk_bytes::ParseHexStr;        // for BlsScalar::from_hex_str
    ...
    //sponge::hash(&test_inputs[..2]);
}

#[test]
fn test_ark_sponge_poseidon_hash() {
    use ark_std::test_rng;
    use ark_sponge::poseidon::{PoseidonParameters, PoseidonSponge};
    use ark_test_curves::bls12_381::Fr;

    let mut rng = test_rng();
    let sponge_param = poseidon_parameters_for_test::<Fr>();

    let elem = Fr::from(114514u128);
    let mut sponge1 = PoseidonSponge::<Fr>::new(&sponge_param);

    sponge1.absorb(&elem);
    let squezzed1 = sponge1.squeeze_native_field_elements(6);
    println!("{:?}", squezzed1);
}
